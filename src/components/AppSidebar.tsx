...
const ADMIN_SECTION: NavSection = {
  ...
  label: "Administração",
  items: [
    { title: "Operações", url: "/admin/operacoes", icon: Settings, roles: ["admin", "orcamentista"] },
    { title: "Saúde da operação", url: "/admin/saude-operacao", icon: HeartPulse, roles: ["admin", "orcamentista"] },
    { title: "Análises", url: "/admin/analises", icon: BarChart3, roles: ["admin", "orcamentista"] },
    { title: "Forecast", url: "/admin/forecast", icon: TrendingUp, roles: ["admin", "orcamentista"] },
    { title: "Metas", url: "/admin/metas", icon: Target, roles: ["admin", "comercial", "orcamentista"] },
