...
import { CheckCircle2, ArrowRight, MessageCircle, Calendar, ShieldCheck, FileText, BarChart3, Clock } from "lucide-react";
    ...
    <section className="space-y-6">
      ...
      <Card>
        <CardContent className="pt-5 pb-4 space-y-3">
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm font-display font-bold text-foreground">Entrega e garantia</p>
          </div>
          <p className="text-sm text-muted-foreground font-body">
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="pt-5 pb-4 space-y-4 text-center">
          <p className="text-sm font-display font-bold text-foreground">Próximo passo</p>
