        ...
        <div className="relative flex items-start justify-between">
          ...
          {steps.map((step, i) => (
            ...
            >
              <div
                className={cn(
                  "w-8 h-8 rounded-full flex items-center justify-center text-xs font-display font-bold transition-all",
                  activeStep === i
        ...
        <Card className="border-primary/20">
          <CardContent className="pt-5 pb-4 space-y-3">
            <p className="text-xs font-display font-semibold text-primary uppercase tracking-wider">
              Etapa {current.id} — {current.title}
            </p>

            <div>
              <p className="text-xs font-display font-semibold text-foreground mb-2">O que acontece</p>
