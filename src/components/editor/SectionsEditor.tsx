...
function SortableItemRow({
  ...
  onUpdate: (sectionId: string, itemId: string, field: string, value: string | number | boolean | null) => void;
...
export function SectionsEditor({ budgetId, sections, onSectionsChange }: SectionsEditorProps) {
  ...
  const updateItem = (sectionId: string, itemId: string, field: string, value: string | number | boolean | null) => {
